            ...
            <Card className="w-full max-w-lg p-8 space-y-8">
                ...
                <div className="flex flex-col sm:flex-row gap-3 min-w-0">
                    <Button
                        ...
                        size="lg"
                        variant="outline"
                        /* 👇 wrap de texto dentro del botón + ancho fluido */
                        className="w-full sm:flex-1 h-14 text-base leading-snug whitespace-normal break-words [overflow-wrap:anywhere] text-center px-4"
                    >
                        Start Random Quiz
                    </Button>
